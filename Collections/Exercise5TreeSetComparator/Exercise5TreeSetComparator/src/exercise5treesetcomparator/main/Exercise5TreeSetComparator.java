 ...
 */
package exercise5treesetcomparator.main;

import exercise5treesetcomparator.services.PaisService;
 ...
 */
public class Exercise5TreeSetComparator {
...
public static void main(String[] args) {
        ...
        while(true){
            ...
            if (opcion == 2){
                ...
                ps.mostrarPaises();
                System.out.println("--- Como se usa treeset, ya vienen ordenados con el Comparator ---");
                ps.mostrarPaises();
